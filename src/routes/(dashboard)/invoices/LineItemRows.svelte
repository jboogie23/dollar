...
<div class="invoice-line-item border-b-2 border-daisyBush">
...
<div class="invoice-line-item">
	<div class="col-span-2">
		<Button isAnimated={false} label="+ Line Item" style="textOnly" onClick={() => {}} />
	</div>
...
<div class="invoice-line-item">
	...
	<div class="relative">
		<input
			class="line-item focus:border-sold h-10 w-full border-b-2 border-dashed border-stone-300 pr-4 text-right focus:border-lavenderIndigo focus:outline-none"
			type="number"
			name="discount"
			min="0"
			max="100"
...
<div class="invoice-line-item">
	<div class="col-span-6">
		<CircledAmount label="Total" amount="$1,444.0" />
	</div>
</div>
